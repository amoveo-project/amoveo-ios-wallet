...
extension UIView {
    ...
    func rounded() {
        rounded(UIColor.white)
    }

    func rounded(_ color: UIColor, borderWidth: CGFloat = 1.0) {
    ...
    func addMultipleSubviews(with subwiews: [UIView]) {
        subwiews.forEach { (view) in
...
class Button: UIButton {
    override func layoutSubviews() {
        super.layoutSubviews()
        self.titleLabel?.font = UIFont.systemFont(ofSize: 34.0)
    }
}
