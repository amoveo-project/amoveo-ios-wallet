...
class EXAHeaderTextFieldView: UIView, UITextFieldDelegate {
    ...
    convenience init(_ placeholder: String, style: UnderlineTextFieldStyle, header: String,
        ...
        _textField = UnderlineTextField(placeholder, style: style, color: placeHolderColor)
